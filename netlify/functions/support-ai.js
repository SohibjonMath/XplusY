...
async function writeReply(db, uid, text, meta={}) {
  ...
  await pushToCustomer(db,uid,{title:escalated?'Murojaatingiz operatorga yuborildi':'OrzuMall yordamchisi javob berdi',body:safeText(text,360),channelId:'orzumall_general_voice_v3',data:{type:'support',url:'https://orzumall.uz/'}}).catch(()=>{});
}
