...
async function loadCatalogLines(db,rawItems){
  ...
  for(const raw of items){
    ...
    const line={
      ...
      sourcePlatform:sourceInfo.platform||null,sourceLabel:sourceInfo.label||null,sourceUrl:sourceInfo.url||null,sourceUpstreamUrl:sourceInfo.upstreamUrl||null,sourceItemId:sourceInfo.itemId||null,externalMarket:sourceInfo.isExternal?{platform:sourceInfo.platform,label:sourceInfo.label,url:sourceInfo.url,upstreamUrl:sourceInfo.upstreamUrl||null,itemId:sourceInfo.itemId}:null,
