  ...
  const forceGalleryContain = ()=>{
    ...
    if(galleryMainBtn){
      ...
      if(isMobileGallery){
        ...
        galleryMainBtn.style.setProperty("display", "block", "important");
    ...
    if(galleryMainImg){
      ...
      if(isMobileGallery){
        galleryMainImg.style.setProperty("position", "absolute", "important");
        galleryMainImg.style.setProperty("inset", "0", "important");
        galleryMainImg.style.setProperty("width", "100%", "important");
        galleryMainImg.style.setProperty("height", "100%", "important");
        galleryMainImg.style.setProperty("max-width", "none", "important");
        galleryMainImg.style.setProperty("max-height", "none", "important");
        galleryMainImg.style.setProperty("margin", "0", "important");
      }else{
