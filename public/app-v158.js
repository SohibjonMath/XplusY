  ...
  const forceGalleryContain = ()=>{
    ...
    if(galleryMainBtn){
      ...
      if(isMobileGallery){
        ...
        galleryMainBtn.style.setProperty("height", "min(calc(100vw - 30px), 360px)", "important");
        galleryMainBtn.style.setProperty("max-height", "360px", "important");
    ...
    if(galleryMainImg){
      ...
      if(isMobileGallery){
        ...
        galleryMainImg.style.setProperty("padding", isChinaGallery ? "7px" : "0", "important");
        ...
        galleryMainImg.style.setProperty("padding", isChinaGallery ? "10px" : "0", "important");
        galleryMainImg.style.setProperty("box-sizing", "border-box", "important");
      }
    }
  };
