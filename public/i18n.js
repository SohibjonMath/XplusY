(function(){
  ...
  const exact = {
    ru: {
      ...
      "Videoni manbada ochish":"Открыть видео в источнике",
      "ta":"шт.",
      ...
      "Mahsulot, do‘kon va toifalarni qidiring":"Ищите товар, магазин или категорию",
      "Sizning tarixingiz":"Ваша история",
      "Yangilash":"Обновить",
      "Ko‘rilgan":"Просмотрено",
      "Tavsiya":"Рекомендуем",
      "Ko‘rilganlar tarixi tozalandi.":"История просмотров очищена.",
      "Butun katalog bo‘yicha qidirilmoqda...":"Поиск по всему каталогу...",
      "Katalog qidiruvini yakunlab bo‘lmadi.":"Не удалось завершить поиск по каталогу.",
      "Siz uchun":"Для вас",
    ...
    en: {
      ...
      "Videoni manbada ochish":"Open video at source",
      "ta":"pcs",
      ...
      "Mahsulot, do‘kon va toifalarni qidiring":"Search products, stores or categories",
      "Sizning tarixingiz":"Your history",
      "Yangilash":"Refresh",
      "Ko‘rilgan":"Viewed",
      "Tavsiya":"Recommended",
      "Ko‘rilganlar tarixi tozalandi.":"Viewing history cleared.",
      "Butun katalog bo‘yicha qidirilmoqda...":"Searching the full catalog...",
      "Katalog qidiruvini yakunlab bo‘lmadi.":"Could not complete catalog search.",
      "Siz uchun":"For you",
